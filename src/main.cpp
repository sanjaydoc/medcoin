...
uint256 hashGenesisBlock("0x478815d43784af0ab9a0bfdc479790618fd2d054067d4fb1fb6a7a61ca6c0944");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Medcoin: 840k blocks in ~4 years
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd8a3f443a96592470b009fc14804afa21c57c21872eebeed2ec95d7993c7dc31");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "06/Nov/2023 - DR.A.Sanjay developed medcoin to decentralize the Healthcare Industry";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("043409f09ca5ff953ac254e72b8312d0a7177b0634243f97e8947b151ae92e10d8dc573165aac05b470d94baf02ad9a3786d6d64863eae8348b6819c006f1cf00f") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1699208897;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2001370836;

        if (fTestNet)
        {
            block.nTime    = 1699208859;
            block.nNonce   = 1768195;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x1d4e95b301f7320ceaff4ec5fb61099b501aa7d72ae3a633b163fb65d3460585"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfc, 0xc2, 0xb5, 0xdc }; // Medcoin: increase each by adding 2 to bitcoin's value.
